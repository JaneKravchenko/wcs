...
function Datepicker() {
	...
	this.regional[ "" ] = { // Default regional settings
		...
		monthNamesShort: ["Січ", "Лют", "Бер", "Кві", "Тра", "Чер", "Лип", "Серп", "Вер", "Жовт", "Лис", "Груд"], // For formatting
		dayNames: ["Неділя", "Понеділок", "Вівторок", "Середа", "Четвер", "П’ятниця", "Субота"], // For formatting
		dayNamesShort: ["Нед", "Пон","Вівт", "Сер", "Чет", "П’ят", "Суб"], // For formatting
		dayNamesMin: ["Нд", "Пд", "Вт", "Ср", "Чт", "Пт", "Сб"], // Column headings for days starting at Sunday
